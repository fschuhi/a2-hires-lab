...
Sub ShowJumpStation()
    ...
    AddJumpTarget "", "Intro", "Intro"
    AddJumpTarget "", "Comments", "> comments <"
    AddJumpTarget "", "Goto Pixel Shifting", "Pixel Shifting"
    AddJumpTarget "", "Goto Sprite Shifter", "Sprite Shifter"
